...
<title>AGW-Interface</title>
  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <!--  Bereich buttons -->
    <div class="category">Kontrollmenue</div>
    <table style="width:50%">
       <colgroup>
        <col span="1" style="background-color:rgb(230,230,230); width: 20%; color:#000000 ;">
        <col span="1" style="background-color:rgb(200,200,200); width: 15%; color:#000000 ;">
    ...
    <table style="width:50%">
      ...
      <tr>
        ...
        <th colspan="1"><div class="heading">Bestaetigung</div></th>
      </tr>
    <tr>
        <!--  -->
        <td><div class="bodytext">Temperatur</div></td>
        <td><div class="tabledata"><input type="text" id="temp_schwellwert" name="temp_schwellwert"></div></td>
        <td><div class="tabledata"><button type="button" class = "btn" id = "btn7" onclick="ButtonPress7()">aendern</button></div></td>
      </tr>
      <tr>
        <!--  -->
        <td><div class="bodytext">Bodenfeuchte</div></td>
        <td><div class="tabledata"><input type="text" id="boden_schwellwert" name="boden_schwellwert"></div></td>
        <td><div class="tabledata"><button type="button" class = "btn" id = "btn8" onclick="ButtonPress8()">aendern</button></div></td>
      </tr>
  ...
  <script type = "text/javascript">
    ...
    function ButtonPress2() {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          document.getElementById("button2").innerHTML = this.responseText;
        }
      }
      */
    ...
    function ButtonPress3() {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          document.getElementById("button3").innerHTML = this.responseText;
        }
      }
      */
    ...
    function ButtonPress7() {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          document.getElementById("button7").innerHTML = this.responseText;
        }
      }
      */
      xhttp.open("GET", "BUTTON_7?temp_schwellwert="+value, false);
      xhttp.send(); 
    }
    ...
    function ButtonPress4() {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          document.getElementById("button4").innerHTML = this.responseText;
        }
      }
      */
    ...
    function ButtonPress5() {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          document.getElementById("button5").innerHTML = this.responseText;
        }
      }
      */
    ...
    function ButtonPress6() {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          document.getElementById("button6").innerHTML = this.responseText;
        }
      }
      */
    ...
    // Auto Light Button aktualisieren
    ...
    // Auto Lüfter Button aktualisieren
    ...
    // Auto Pumpe Button aktualisieren
